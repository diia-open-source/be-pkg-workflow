...
export async function decrypt(encryptedData: Uint8Array, key: crypto.CryptoKey): Promise<Uint8Array> {
    const iv = encryptedData.subarray(0, IV_LENGTH_BYTES) as Uint8Array<ArrayBuffer>
    const ciphertext = encryptedData.subarray(IV_LENGTH_BYTES) as Uint8Array<ArrayBuffer>
