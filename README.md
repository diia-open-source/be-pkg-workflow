...
```
git clone https://github.com/diia-open-source/be-pkg-workflow.git pkg-workflow
```
...
In order to install and use the linked dependencies for `pkg-workflow` the following command can be used:
